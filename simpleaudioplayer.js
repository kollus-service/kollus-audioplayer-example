...
function removeHide(id) {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    repeat1.addEventListener('click', function(evt) {
    ...
    repeat2.addEventListener('click', function(evt) {
      var current = player.get_progress();
      repeated = 2;
    ...
    repeat3.addEventListener('click', function(evt) {
    ...
    s_down.addEventListener('click', function(evt) {
    ...
    s_up.addEventListener('click', function(evt) {
    ...
    no_replay.addEventListener('click', function(evt) {
      setHide('no_replay');
      removeHide('replay');
      is_replay = 0;
    });
    ...
    sound.addEventListener('click', function(evt) {
      player.mute();
    });
    //progress
